        ...
        <div id='AboutMe' className="min-w-screen min-h-screen bg-gradient-to-br from-rose-600 to-sky-500 px-4 py-8 flex flex-col items-center justify-center">
            <div className="text-center mb-10">
                <img
                    ...
                    alt="Sutrawe A. C." 
                />
                <h1 className="text-3xl sm:text-4xl p-2 inline-block font-black font-heading mt-4 text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-purple-500 to-rose-600">Sutrawe A. C.</h1>
